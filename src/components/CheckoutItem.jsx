...
function CheckoutItem({img, title, price, desc, quantity, updateQuantity, removeFromCart}) {
	...
	return (
		<div className="flex justify-between px-8 py-8">
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 cursor-pointer select-none hover:scale-125 transition-all duration-200" onClick={handleItemDeletion}>
